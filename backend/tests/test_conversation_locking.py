...
from agent.memory import ConversationState, SessionLockManager
...
class EchoGraph:
    """用轻量图替代 LangGraph，专注验证 Runner 的锁保护边界。"""

    def __init__(self, store: CopyOnReadConversationStore, delay_seconds: float = 0.02):
        self.store = store
